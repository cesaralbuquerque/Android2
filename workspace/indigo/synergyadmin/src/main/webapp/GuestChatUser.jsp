...
<body>
<%
	String toUID = Util.toString(request
			.getAttribute("toUID"));
...
<script type="text/javascript">
			...
			var attributes = {};
			swfobject.embedSWF("flash/GuestChatUser_1.swf", "SynergyChatFlash", stageW, stageH, "9.0.0", "flash/expressInstall.swf", flashvars, params, attributes);
		</script>
