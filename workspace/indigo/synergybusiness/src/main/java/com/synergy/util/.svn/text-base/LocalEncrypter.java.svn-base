...
public class LocalEncrypter {
	...
	private static void setUp() throws Exception {
		...
		System.out.println(coder.encodeToString(key.getEncoded()));
	...
	public static String decryptString(String encoded) throws InvalidKeyException, BadPaddingException, IllegalBlockSizeException {
